<%@ Page Title="" Language="C#" MasterPageFile="~/RS_Site.Master" AutoEventWireup="true" CodeBehind="Student_Signup.aspx.cs" Inherits="RS_Project.Student_Signup" %>
...
-moz-box-shadow: -1px -1px 31px 16px rgba(0,0,0,0.75);">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                <h1 class="jumbotron bg-primary text_white text-center">SignUp</h1>
                </div>
         </div>       
