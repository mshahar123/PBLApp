<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin_dashboard.Master" AutoEventWireup="true" CodeBehind="View_Contact.aspx.cs" Inherits="RS_Project.admin.View_Contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h1 class="jumbotron bg-red text-red text-center" >VIEW CONTACT DETAILS</h1>

        </div>
    <asp:GridView CssClass="table table-bodered table-hover table-striped table-red text-center " ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting">
        <Columns>
